  ...
  return (
    <section id="aboutMe" className="card m-3 border-light shadow-sm">
      <div className="m-1 card-body">
        ...
        <p>
          I am passionate about writing clean code that adheres to software
          principles such as DRY and reusability and designing interfaces that
          optimize accessibility & user experience.
        </p>
        <p>
          In the past, I headed a team of 6 data entry clerks for a local refuse
          collection company for 5 years. As the company grew we constantly
          needed to develop new systems and procedures to keep up with the
